...
static const int64 MAX_MONEY = 10000000000 * COIN; // maximum transaction
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // 5760 blocks found a day. Priority cutoff is 1 CBOX day / 250 bytes.
    }
